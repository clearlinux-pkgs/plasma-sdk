...
Version  : 5.17.1
Release  : 26
URL      : https://download.kde.org/stable/plasma/5.17.1/plasma-sdk-5.17.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.17.1/plasma-sdk-5.17.1.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.17.1/plasma-sdk-5.17.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571803999
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-sdk-5.17.1/COPYING %{buildroot}/usr/share/package-licenses/plasma-sdk/579588a75aec3d4f0d4629a074965f459f4e2504
cp %{_builddir}/plasma-sdk-5.17.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/plasma-sdk/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
