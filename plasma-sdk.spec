...
Version  : 5.14.0
Release  : 3
URL      : https://download.kde.org/stable/plasma/5.14.0/plasma-sdk-5.14.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.0/plasma-sdk-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/plasma-sdk-5.14.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0 LGPL-2.1
Requires: plasma-sdk-bin
Requires: plasma-sdk-lib
Requires: plasma-sdk-data
Requires: plasma-sdk-license
Requires: plasma-sdk-locales
Requires: plasma-sdk-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1539118539
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1539118539
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/plasma-sdk
cp COPYING %{buildroot}/usr/share/doc/plasma-sdk/COPYING
cp COPYING.LIB %{buildroot}/usr/share/doc/plasma-sdk/COPYING.LIB
pushd clr-build
%make_install
popd
...
/usr/share/doc/plasma-sdk/COPYING
/usr/share/doc/plasma-sdk/COPYING.LIB
