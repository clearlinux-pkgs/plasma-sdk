...
Version  : 5.13.5
Release  : 2
URL      : https://download.kde.org/stable/plasma/5.13.5/plasma-sdk-5.13.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.13.5/plasma-sdk-5.13.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.13.5/plasma-sdk-5.13.5.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1536089908
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
